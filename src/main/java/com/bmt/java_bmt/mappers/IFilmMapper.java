...
public interface IFilmMapper {
    ...
    @Mapping(
            source = "filmProfessionals",
            target = "filmProfessionals",
            qualifiedByName = "mapFilmProfessionalsToUuids")
    ...
    */
    ...
    default Set<UUID> mapFilmProfessionalsToUuids(Set<FilmProfessional> professionals) {
        ...
        return professionals.stream().map(FilmProfessional::getId).collect(Collectors.toSet());
    }
}
